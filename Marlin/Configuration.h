...
#define STRING_CONFIG_H_AUTHOR "JenkinsPost A8" // Who made the changes.
...
#define DEFAULT_bedKp 279.06
#define DEFAULT_bedKi 49.92
#define DEFAULT_bedKd 1040.05
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {52.00, 16, -2}
