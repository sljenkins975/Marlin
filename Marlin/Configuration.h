...
#define STRING_CONFIG_H_AUTHOR "(JenkinsPost, Ender-3)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 21.83, 21.12, 101.67, 141 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { +48, -2, -1.3 }
